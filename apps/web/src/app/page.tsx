...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 h-20">
          <nav className="flex items-center justify-between h-full">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <a href="#footer" className="text-gray-600 hover:text-primary hover:bg-primary/10 rounded-full px-4 py-2 text-sm font-medium transition-colors">
                Contato
              </a>
            </div>
      ...
      {/* Footer */}
      <footer id="footer" className="bg-gray-900 text-white py-16 scroll-mt-20">
        <div className="container mx-auto px-4">
